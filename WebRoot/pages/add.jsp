...
<div id="navbar" class="wrap">
	<div class="profile">
		...
		<span class="addnew"><a href="${pageContext.request.contextPath}/WebRoot/pages/add">添加新投票</a></span>		
	</div>
	<div class="search">
...
<div id="voteManage" class="box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-0" data-genuitec-path="/votsyste/WebRoot/pages/add.jsp">
	<h2>添加新投票</h2>
	<div class="content">
	<form method="post" action="${pageContext.request.contextPath}/m/DoAddServlet">
			<dl>
				<dt>投票内容：</dt>
				<dd>
